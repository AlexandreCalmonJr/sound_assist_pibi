/**
 * SoundMaster Pro — DSP Utilities: Spectrum Calculator
 * ====================================================
...
export const SpectrumCalculator = {
    /**
    ...
    calculateSPL(magnitudeDb, sampleRate, fftSize, weighting = 'A') {
        ...
        for (let i = 1; i < magnitudeDb.length; i++) { // Skip DC
        ...
        // Assumindo calibração: 0 dBFS = 94 dBSPL
    ...
    _getWeight(type, f) {
        ...
        return type === 'A' 
            ...
            : 0; // C-weighting pode ser adicionada se necessário
    }
};

export default SpectrumCalculator;