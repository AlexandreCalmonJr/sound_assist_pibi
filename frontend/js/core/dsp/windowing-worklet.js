/**
 * SoundMaster Pro — DSP Utilities: Windowing Worklet-Ready
 * ==========================================================
 * Funções de janelamento para análise espectral em AudioWorklet.
...
export const WindowingWorklet = {
    ...
    /**
     * Calcula fator de normalização para amplitude correta
    ...
    /**
     * Calcula fator de normalização para energia
     * @param {Float64Array} window 
     * @returns {number}
     */
...
export default WindowingWorklet;